...
class VPMonthDisplayVM: VPCalendarViewProtocol {
    ...
    func registerCells(forCollectionView collectionView: UICollectionView) {
        collectionView.register(UINib(nibName: String(describing: VPDayDisplayCollectionViewCell.self), bundle: nil), forCellWithReuseIdentifier: String(describing: VPDayDisplayCollectionViewCell.self))
        collectionView.register(UINib(nibName: String(describing: VPMonthDisplayCollectionReusableView.self), bundle: nil), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: String(describing: VPMonthDisplayCollectionReusableView.self))
    }
