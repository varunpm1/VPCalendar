...
protocol VPCalendarViewProtocol {
...
public class VPCalendarView: UIView {
    /// Used to identify the display type needed currently. Defaults to `yearly` view.
    public var calendarDisplayType: VPCalendarDisplayType = .monthly
    ...
    // Used to transit between different calendar types
    private let monthDisplayVM = VPMonthDisplayVM()
    ...
    private func setupInitialUI() {
        ...
        Bundle(for: VPCalendarView.self).loadNibNamed(String(describing: VPCalendarView.self), owner: self, options: nil)
        ...
        monthDisplayCollectionView.register(UINib(nibName: String(describing: VPMonthDisplayCollectionViewCell.self), bundle: Bundle(for: VPCalendarView.self)), forCellWithReuseIdentifier: String(describing: VPMonthDisplayCollectionViewCell.self))
        monthDisplayCollectionView.register(UINib(nibName: String(describing: VPYearDisplayCollectionReusableView.self), bundle: Bundle(for: VPCalendarView.self)), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: String(describing: VPYearDisplayCollectionReusableView.self))
